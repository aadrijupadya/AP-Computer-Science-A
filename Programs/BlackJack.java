        ...
        while (!megaendgame) {
            ...
            while (Sum(player) <= 21 && (!endgame)) {
                ...
                if (response.equals("Hit")) {
                    ...
                    deck = ArrayHelper.removeMid(deck, a);
                    ...
                    while (Sum(dealer) <= 17) {
                        ...
                        deck = ArrayHelper.removeMid(deck, b);
                        displayCards2(player, dealer);
                        if (Sum(dealer) > 21) {
